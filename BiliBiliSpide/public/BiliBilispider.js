...
//初始url
        ...
        http.get(x, function (res) {
            ...
            res.on('end', function () {
                ...
                var title = $('.info-title').text().trim(),
                    ...
                    barrage = $('.info-count-item-review').find('en').text().trim(),
                ...
                if (av !== undefined) {
                    ...
                    // num = playNum.indexOf('万') == playNum.length - 1 ? parseFloat(num) * 10000 : parseFloat(num);
                    // var news_title = "[" + num + "]" + av + " " + title + " [" + tag + "]  " + playNum;
                    // var new_contnt = "标题：" + title +
                    //     "\r\n番号：" + av +
                    //     "\r\n标签：" + tag +
                    //     "\r\n播放次数：" + playNum +
                    //     "\r\n追番人数：" + fans +
                    ...
                    // savedContent($, news_title, new_contnt);
                }
                i = i + 1;
    ...
    function savedContent($, new_contnt) {
        ...
        client.query(
            ...
            function selectCb(err, results, fields) {
                ...
                if (results) {
                    ...
                    var userAddSql_Params = [new_contnt.title, parseFloat(new_contnt.av), new_contnt.tag, new_contnt.playNum, new_contnt.fans, parseFloat(new_contnt.barrage),
        ...
        // fs.appendFile('./data/' + news_title + '.txt', new_contnt, 'utf-8', function (err) {
        //     if (err) {
        //         console.log(err);
        //     }
        // });
